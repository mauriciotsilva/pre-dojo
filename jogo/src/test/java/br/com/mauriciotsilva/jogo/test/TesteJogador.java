...
public class TesteJogador {
	...
	private void verificarContatores(Jogador jogador, int assassinato, int morte, int streak) {
	...
	private void verificarNumeroMorte(Jogador jogador, int valor) {
		Assert.assertTrue("Numero Morte: " + jogador, jogador.getQuantidadeMorte() == valor);
	}

	private void verificarNumeroAssanatos(Jogador jogador, int valor) {
		Assert.assertTrue("Numero Assassinato: " + jogador, jogador.getQuantidadeAssassinato() == valor);
	}

	private void verificarNumeroStreak(Jogador jogador, int valor) {
		Assert.assertTrue("Numero Streak:" + jogador, jogador.getNumeroStreak() == valor);
	}
